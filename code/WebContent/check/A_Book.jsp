...
<head>
	...
	<script type="text/javascript"	 src="jquery/plugins/datagrid-filter.js"></script></head>
...
<body class="templatemo_juice_bg">
	...
	<input id="new_isbn" type="text" class="easyui-validatebox" required="true"  /><br /> <br /> 

	<label class="lbInfo">Title: </label> 
	<input id="new_book_name" type="text" class="easyui-validatebox" required="true"  /><br /> <br /> 

	<label class="lbInfo">Author: </label> 
	<input id="new_author_name" type="text" class="easyui-validatebox" required="true"  /><br /> <br /> 

	<label class="lbInfo">Price: </label> 
	<input id="new_price" class="easyui-numberbox" precision="2" value="0"></input><br /> <br /> 
	...
	<input id="new_store" class="easyui-numberbox" precision="0" value="0"></input><br /> <br /> 
	...
	<input id="search_price" class="easyui-numberbox" precision="2" value="0"></input><br /> <br /> 
